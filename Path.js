class Path extends Phaser.Scene {
    ...
    addPoint(point) {
        this.curve.addPoint(point); // Adding the current cursor's x and y values (point) to the points array.
        this.xImages.push(this.add.image(point.x, point.y, "x-mark")); // Adding an x-mark image to the xImages array at the current point.
    }
    ...
    update() {
        ...
        if (Phaser.Input.Keyboard.JustDown(this.rKey)) {
            ...
            if (this.run_mode)
            {
                console.log("Run mode activated!");
            ...
            {
                console.log("Run mode deactivated!");
